...
public class LogUtils {
	...
	private static String dataPattern = PropertiesUtil.getProperty("drquery.service/runtime.properties","qryLog.datePattern");
	//private static String qryLogPath = PropertiesUtil.getProperty("drquery.service/runtime.properties","qryLog.path");
	...
	private static Logger createMonitorLogger(){
        ...
        if(dataPattern == null || "".equals(dataPattern))
        	dataPattern="yyyyMMddHH";
        appender.setDatePattern("'.'"+dataPattern);

        //日志文件路径
        String qryLogPath = System.getProperty("drquery.checkFile.path");
        if(StringUtils.isEmpty(qryLogPath)){
        	log.warn("system property: 'drquery.checkFile.path' is not set in runtime.properties.");
        	qryLogPath = System.getProperty("$webapp.root");
        }
	...
	public static void main(String[] args) throws Exception{
		System.setProperty("drquery.checkFile.path", "d:/logs/");

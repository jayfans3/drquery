...
public class DBDataSource implements BaseDataSource {
    ...
    @Override
    public List<String[]> loadDR(DRQueryParameters queryParameters, MetaModel metaModel) throws DataSourceException {
        return null;
    }

    @Override
    public List<Map<String, String>> loadDR(String sql, Object[] args) throws DataSourceException {
        return null;
    }
}

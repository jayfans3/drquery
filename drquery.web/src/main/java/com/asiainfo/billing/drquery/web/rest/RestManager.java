package com.asiainfo.billing.drquery.web.rest;
...
public class RestManager 
{
	...
	public static String postWithJson(String uri, Map paramMap) throws IOException{
		...
		try{
			method= new PostMethod();
			method.setURI(new URI(uri, false));
			RequestEntity entity = new org.apache.commons.httpclient.methods.StringRequestEntity(JSONObject.fromMap(paramMap).toString(), "text", "UTF-8");

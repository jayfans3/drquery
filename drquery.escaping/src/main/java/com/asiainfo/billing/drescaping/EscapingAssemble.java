...
public class EscapingAssemble{
    ...
    private EscapingProcess getEscapingProcess(String busiType){
        ...
        while(!("".equals(PropertiesUtil.getProperty(busiType+"."+i, "")))){
            ...
            String month=PropertiesUtil.getProperty(busiType+"."+i+".month","");
            ...
            String querySQL="";
            if(!month.equals(null)&&month.trim().equals("true")){
            	Calendar a=Calendar.getInstance();
            	a.roll(Calendar.MONTH, false);
            	Date c=a.getTime(); 
            	SimpleDateFormat sdf=new SimpleDateFormat("_yyyyMM");
            	querySQL=PropertiesUtil.getProperty(busiType+"."+i+".sql")+sdf.format(c);
            }else{
            	querySQL=PropertiesUtil.getProperty(busiType+"."+i+".sql","");
            }

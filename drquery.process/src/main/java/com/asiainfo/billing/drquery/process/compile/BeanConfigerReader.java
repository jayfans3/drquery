...
public class BeanConfigerReader implements InitializingBean{
	...
	public static final String CONFIG_PATH = PropertiesUtil.getProperty("drquery.service/runtime.properties","javaSource.config.path");
	public static final String CLASSPATH = PropertiesUtil.getProperty("drquery.service/runtime.properties","javaSource.config.classpath");
	...
	public void afterPropertiesSet() throws Exception {
		//log.info("JAVA_SOURCE_CONFIG_PATH = " + CONFIG_PATH);
	...
	public void cacheMethod(Class clz){
		...
		for(Method method : methods){
			...
			cache.putData2Cache(methodKey, fastMethod, false);

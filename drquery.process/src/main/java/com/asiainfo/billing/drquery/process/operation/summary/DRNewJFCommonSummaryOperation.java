...
//			}
			//通过反射调用
			val = (StatMetaDescriptor<String,Object>) BeanInvoker.invoke("commonSummaryRule", methodName, new Object[]{rowData, request, stat}, new Class[]{Map.class, DRProcessRequest.class, StatMetaDescriptor.class});
		}catch(Exception e){

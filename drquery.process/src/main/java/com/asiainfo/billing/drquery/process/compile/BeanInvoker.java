...
public class BeanInvoker {
	...
	public static Object invoke(String beanId, String methodName, Object[] params, Class[] classes) throws Exception{
		...
		Object value = fastMethod.invoke(instance, params);

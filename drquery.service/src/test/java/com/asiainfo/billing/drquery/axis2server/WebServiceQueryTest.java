...
public class WebServiceQueryTest {
    ...
    */
    ...
    public void testWebService() throws Exception {
        ...
        String f1 = "{phoneNo:'18601134210', interfaceType:'F1'}";
        String f2 = "{phoneNo:'18601134210', interfaceType:'F2', dataMonth: '201505', isCurrentMonth: 0}";
        Object[] result = client.invokeBlocking(qname, new String[]{f2}, new Class[]{String.class});
